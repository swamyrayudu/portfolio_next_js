...
export const BackgroundBeamsWithCollision = ({
  ...
  const beams = [
    ...
    },
    {
      ...
      duration: 10, // Slower duration
      repeatDelay: 7,
      className: "h-4", // Thinner beam
    },
    {
      initialX: 400,
      translateX: 400,
      duration: 7, // Slower duration
      repeatDelay: 14,
      delay: 4,
    },
    {
  ...
  return (
    <>
      <motion.div
        ...
        transition={{
          duration: beamOptions.duration || 12, // Default slower duration
          repeat: Infinity,
          repeatType: "loop",
          ease: "linear",
